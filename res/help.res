...
4单行注释#为各种编程语言的源文件快速添加单行注释。常见的单行注释有：\nada、lua、sql --\nc、cpp、cs、h、java、js、jsp、m、pas、php //\ninf、ini、lisp、reg ;\nmk、pl、py、rb、sh 井号\nbat ::\nasp、vb '
4区块注释#为各种编程语言的源文件快速添加区块注释。常见的区块注释有：\nc、cpp、cs、css、h、java、js、jsp、m、php、sql /* */\nhtm、html、xml <!-- -->\nlua --[[ --]]\npas { }\npl =pod =cut\npy ''' '''\nrb ==begin ==end\nsh :<<'COMMENT' COMMENT\nst " "
...
3颜色设置#设置文本域中各状态下字体、背景和光标的颜色，包括：字体、背景、光标、选区字体、选区背景颜色等。
4字体颜色#设置普通状态下的字体颜色。
4背景颜色#设置普通状态下的背景颜色。
4光标颜色#设置光标颜色。
4选区字体颜色#设置选区内的字体颜色。
...
3配色方案#设置预置的配色方案，包括：字体、背景、光标、选区字体、选区背景颜色等。
4配色方案1#设置第1种预置的配色方案。
4配色方案2#设置第2种预置的配色方案。
4配色方案3#设置第3种预置的配色方案。
4配色方案4#设置第4种预置的配色方案。
