...
public final class Util {
  ...
  public static final String[] SHORTCUT_NAMES = new String[] {
      ...
      "全选","删除","拆分文件","切换为大写","切换为小写","复制当前文件名到剪贴板","复制当前文件路径到剪贴板","复制当前目录路径到剪贴板","复制所有文本到剪贴板","复写当前行","删除当前行","删除重行",
      "删除至行首","删除至行尾","删除至文件首","删除至文件尾","上移当前行","下移当前行","复制当前行","剪切当前行","批量切除行","批量插入行",
      "批量分割行","批量拼接行","批量合并行","逐行复写","升序排序","降序排序","反序排序","缩进","退格","清除行首空白","清除行尾空白",
      "清除行首和行尾空白","清除选区内空白","删除全文空行","删除选区空行","添加/取消单行注释","添加/取消区块注释","插入特殊字符","插入时间和日期","复写选区字符","反转选区字符",
      "查找","查找下一个","查找上一个","选定查找下一个","选定查找上一个","快速向下查找","快速向上查找","替换","转到","设置/取消书签","下一个书签","上一个书签","复制书签行","清除所有书签","定位匹配括号",
      ...
      "Unicode Big Endian编码格式","代码格式化-json","列表符号与编号","字体","Tab键设置","自动完成","自动换行","自动缩进","恢复默认设置","后退","前进","显示/隐藏工具栏",
      ...
      "后一个文档","统计信息","窗口管理","加密","进制转换","计算器","切割文件","拼接文件","转换文件编码","转换文件换行符","帮助主题","关于"
      }; // 快捷键的名称
  public static final String[] SHORTCUT_VALUES = new String[] {
      ...
      "Ctrl+65","127","","Ctrl+Shift+85","Ctrl+85","","","","Ctrl+Shift+65","Ctrl+68","Ctrl+Shift+68","Ctrl+Alt+Shift+68",
