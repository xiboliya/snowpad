...
public final class Util {
  ...
  public static final String[] SHORTCUT_NAMES = new String[] {
      ...
      "Unicode Big Endian编码格式","列表符号与编号","字体","Tab键设置","自动完成","自动换行","自动缩进","恢复默认设置","后退","前进","显示/隐藏工具栏",
  ...
  public static final int LINE_NUMBER_MARGIN = 3; // 行号组件的左边距
  ...
  public static final Color COLOR_BOOKMARK = new Color(128, 0, 128); // 书签的颜色
