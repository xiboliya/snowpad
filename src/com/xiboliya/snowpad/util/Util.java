...
public final class Util {
  ...
  public static final String[] SHORTCUT_NAMES = new String[] {
      ...
      "后一个文档","定位到行首","定位到行尾","定位到文件首","定位到文件尾","统计信息","窗口管理","计算器","散列/哈希加密","加密/解密","切割文件","拼接文件","转换文件编码","转换文件换行符","文本格式转换","数字进制转换","时间戳转换","单位换算","三角函数","题库","统计求和","统计平均值","统计最大值","统计最小值","统计升序排列","统计降序排列","精简gradle依赖","帮助主题","关于"
      }; // 快捷键的名称
