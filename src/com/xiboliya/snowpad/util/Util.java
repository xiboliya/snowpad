...
public final class Util {
  ...
  public static final String VERSION = "V5.1"; // 软件版本号
  ...
  public static final String[] SHORTCUT_NAMES = new String[] {
      ...
      "单词边界换行","字符边界换行","Windows换行符格式","Unix换行符格式","Macintosh换行符格式","GB18030编码格式","ANSI编码格式","UTF-8编码格式","UTF-8 No BOM编码格式","Unicode Little Endian编码格式",
      "Unicode Big Endian编码格式","代码格式化-json","代码压缩-json","列表符号与编号","字体","Tab键设置","自动完成","自动换行","自动缩进","首选项","恢复默认设置","后退","前进","显示/隐藏工具栏",
